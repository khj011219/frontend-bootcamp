...
document.getElementById('hourup')?.addEventListener('click', () => stepInput('hourInput', +1, 0, 23));
document.getElementById('hourdown')?.addEventListener('click', () => stepInput('hourInput', -1, 0, 23));
document.getElementById('minuteup')?.addEventListener('click', () => stepInput('minuteInput', +1, 0, 59));
document.getElementById('minutedown')?.addEventListener('click', () => stepInput('minuteInput', -1, 0, 59));
document.getElementById('secondup')?.addEventListener('click', () => stepInput('secondInput', +1, 0, 59));
document.getElementById('seconddown')?.addEventListener('click', () => stepInput('secondInput', -1, 0, 59));
...
function hmsFromInputs() {
  const h = clamp(Number(document.getElementById('hourInput')?.value || 0), 0, 23);
  const m = clamp(Number(document.getElementById('minuteInput')?.value || 0), 0, 59);
  const s = clamp(Number(document.getElementById('secondInput')?.value || 0), 0, 59);
...
function checkAlarms() {
  ...
  if (alarms.has(now)) {
    ...
    const list = getAlarmListEl();
    if (list) {
      list.querySelectorAll('.alarm-item .alarm-time')
        .forEach((span) => {
